...
class ActionComponent {
    ...
    customActionHandler(btnInfo) {
        var _a, _b;
        dispatch(new CustomAction(btnInfo.actionName, (_a = this.params) === null || _a === void 0 ? void 0 : _a.data));
        console.log(btnInfo.actionName, (_b = this.params) === null || _b === void 0 ? void 0 : _b.data);
    }
    editRowData() {
        var _a, _b, _c;
        if ((_a = this.params) === null || _a === void 0 ? void 0 : _a.crudEdit) {
            (_b = this.params) === null || _b === void 0 ? void 0 : _b.crudEdit((_c = this.params) === null || _c === void 0 ? void 0 : _c.data);
        }
    }
    deleteRowData() {
        var _a;
        if ((_a = this.params) === null || _a === void 0 ? void 0 : _a.crudDelete) {
...
class CellRendererComponent {
    get userStatus() {
        var _a;
        return (_a = this.params) === null || _a === void 0 ? void 0 : _a.templateName.startsWith('<user-status');
    }
    agInit(params) {
        this.params = params;
    }
...
class ColumnSelectorComponent {
    ...
    checkColumnInputValue() {
        var _a;
        return ((_a = this.searchColumnInput) === null || _a === void 0 ? void 0 : _a.nativeElement.value) ? true : false;
    }
    getCheckedLen() {
...
class StlGridComponent {
            ...
            if (!(it.list && it.list.hidden)) {
                ...
                if (this.hasAnotherDataSource(it)) {
                    col.cellRenderer = (params) => {
                        var _a;
                        const find = ((_a = this.resourceStorage[params.resourceKey]) !== null && _a !== void 0 ? _a : []).find(el => el.value === params.value);
            ...
            next: (res) => {
                if (!res.isSuccess) {
                    ...
                    if (operationKey === ConstantService.OperationType.INSERT) {
                        ...
                        rowNode === null || rowNode === void 0 ? void 0 : rowNode.updateData(record);
                        setTimeout(() => {
                            rowNode === null || rowNode === void 0 ? void 0 : rowNode.setData(record);
                        }, 100);
                    }
                }
            },
    ...
    setMultiOptionValue() {
        ...
        const observables = [];
        this.invokingUrlList = [];
        (_a = this.tableConfig) === null || _a === void 0 ? void 0 : _a.forEach((element) => {
    ...
    getPayload(params) {
        ...
        return {
            ...
            page: Math.floor(params.startRow / ((_a = this.gridOptions.paginationPageSize) !== null && _a !== void 0 ? _a : 1)),
